...
const ServiceHighlights = () => {
  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-16 bg-gradient-to-br from-stone-50 via-amber-50 to-orange-50">
      <div className="max-w-8xl mx-auto">
        {/* Adjusted grid column ratio */}
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          {/* Left Column - Images */}
          <motion.div
            className="relative grid grid-cols-2 gap-2 lg:col-span-3 w-full"
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: true }}
          >
            <div className="row-span-2 flex flex-col gap-2 mt-6 sm:mt-10 lg:mt-16">
              <motion.div
